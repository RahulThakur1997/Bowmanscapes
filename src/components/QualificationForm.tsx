...
export const QualificationForm: React.FC<QualificationFormProps> = ({
  ...
  const serviceOptions = [
    ...
    { id: 'Artificial Turf', label: 'Artificial Turf', desc: 'Low-maintenance grass' },
    { id: 'Turfing', label: 'Natural Turf', desc: 'Ground prep & fresh turf' },
    { id: 'Decking', label: 'Decking', desc: 'Composite & timber platforms' },
    { id: 'Gates', label: 'Gates', desc: 'Timber side gates & access' },
    { id: 'General Building', label: 'General Building', desc: 'Garden walls, brickwork & steps' },
    { id: 'High-Pressure Water Treatment', label: 'Pressure Washing', desc: 'Patios, drives & stone' },
    { id: 'Repointing', label: 'Repointing', desc: 'Joints, brickwork & walls' },
    { id: 'Gutter Clearance', label: 'Gutter Clearance', desc: 'Gutters & downpipes' },
    { id: 'Drainage', label: 'Drainage', desc: 'Standing water & run-off' },
  ];
      ...
      {!isSubmitted ? (
        <>
          ...
          <div className="mb-5">
            ...
            <h3 className="text-xl sm:text-2xl font-black text-[#111111] font-display">
              ...
              <div className="space-y-3.5 animate-in fade-in duration-200" id="form-step-1">
                    ...
                    return (
                      <button
                        ...
                        className={`text-left p-3 rounded-xl border text-xs transition-all duration-150 relative cursor-pointer group flex flex-col justify-between ${
                          isSelected
                            ? 'border-[#d7393e] bg-[#d7393e]/5 text-[#111111] font-bold ring-1 ring-[#d7393e]/30 shadow-xs'
                            : 'border-gray-200 bg-[#F7F7F7] hover:border-gray-400 text-gray-800'
                        }`}
                      >
                        <div className="flex items-center justify-between w-full mb-1">
                          <span className="font-bold text-xs text-[#111111]">{opt.label}</span>
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#111111] hover:bg-black text-white font-bold text-sm shadow-md transition-colors cursor-pointer group"
                  >
              ...
              <div className="space-y-3.5 animate-in fade-in duration-200" id="form-step-2">
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left p-3 rounded-xl border transition-all duration-150 cursor-pointer flex items-center justify-between ${
                          isSelected
                            ? 'border-[#d7393e] bg-[#d7393e]/5 text-[#111111] ring-1 ring-[#d7393e]/30 shadow-xs'
                            : 'border-gray-200 bg-[#F7F7F7] hover:border-gray-300 text-[#111111]'
                        }`}
                      >
                        <div className="pr-2">
                          <div className="flex items-center gap-2">
                            <span className="font-bold text-sm text-[#111111]">{freq.title}</span>
                ...
                <div className="flex items-center gap-3 pt-2">
                  <button
                    type="button"
                    onClick={handleBack}
                    className="p-3 rounded-xl border border-gray-200 text-[#111111] hover:bg-gray-50 text-sm font-medium transition-colors flex items-center justify-center"
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#111111] hover:bg-black text-white font-bold text-sm shadow-md transition-colors cursor-pointer group"
                  >
              ...
              <div className="space-y-3 animate-in fade-in duration-200" id="form-step-3">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-3 py-2 bg-[#F7F7F7] border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#d7393e] transition-all ${
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2 bg-[#F7F7F7] border border-gray-200 rounded-xl text-xs text-[#111111] focus:outline-none focus:ring-2 focus:ring-[#d7393e]"
                  >
              ...
              <div className="space-y-3.5 animate-in fade-in duration-200" id="form-step-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full p-3 bg-[#F7F7F7] border border-gray-200 rounded-xl text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#d7393e] resize-none"
                  />
                </div>
        ...
        <div className="py-6 text-center space-y-4 animate-in zoom-in-95 duration-200" id="form-success-state">
          ...
          <div>
            ...
            <h3 className="text-2xl font-black text-[#111111] mt-2 font-display">
          ...
          <div className="p-4 rounded-2xl bg-[#F7F7F7] border border-gray-200 max-w-xs mx-auto text-left text-xs space-y-1.5">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-[#111111] text-white text-xs font-bold hover:bg-black transition-colors"
            >
            ...
            <button
              type="button"
              onClick={handleReset}
              className="text-xs font-semibold text-gray-500 hover:text-[#111111] underline cursor-pointer py-1"
            >
