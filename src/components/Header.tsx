      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div className="w-10 h-10 rounded-xl bg-[#111512] flex items-center justify-center text-white shadow-md group-hover:bg-[#1f2420] transition-colors border border-white/10">
              <svg
                viewBox="0 0 28 28"
                className="w-6 h-6"
                fill="none"
            ...
            {navLinks.map((link) => (
              <a
                ...
                className={`text-[15px] font-medium transition-colors relative py-1 hover:font-semibold ${
                  isScrolled
                    ? 'text-[#111512]/80 hover:text-[#d7393e]'
          ...
          <div className="hidden md:flex items-center gap-5">
            <a
              ...
              className={`flex items-center gap-2 text-sm font-semibold transition-colors py-2 px-3 rounded-lg ${
                isScrolled
                  ? 'text-[#111512] hover:text-[#d7393e] hover:bg-gray-100'
            ...
            >
              ...
              <div className="text-left">
                <span className={`block text-[11px] font-medium leading-none ${
                  isScrolled ? 'text-[#667067]' : 'text-white/70'
                }`}>Call Matt</span>
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-white border border-gray-200 text-[#111512] shadow-sm hover:bg-gray-50 transition-colors"
            >
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          <div className="flex flex-col space-y-3 pt-2">
            {navLinks.map((link) => (
              <a
                ...
                className="text-lg font-semibold text-[#111512] hover:text-[#d7393e] py-1 border-b border-gray-100 transition-colors"
              >
                {link.name}
              </a>
            ))}
          ...
          <div className="pt-4 space-y-3">
            ...
            <a
              href={`tel:${COMPANY_INFO.phoneClean}`}
              className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#F8F9F8] text-[#111512] font-semibold text-sm border border-gray-200"
            >
